...
export function EditLessonDialog({
  ...
  const autosaveKey = lesson ? `edit_lesson_${lesson.id}_autosave` : "edit_lesson_autosave"
  ...
  const handleSave = () => {
    ...
    console.log("Lección actualizada:", { title, description, resources: lesson?.resources })
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-2">
          ...
          <TabsContent value="resources" className="space-y-4 pt-4">
            <div className="grid gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  onClick={() => onAddResource(newResourceName, lesson)}
                >
            ...
            <div className="grid gap-2">
              ...
              <div className="flex items-center gap-2">
                <Input id="resource-file" type="file" className="border-blue-200 focus-visible:ring-blue-500" />
                <Button variant="outline" className="border-blue-200 text-blue-600 hover:bg-blue-50">
                  <Upload className="mr-2 h-4 w-4" />
                  Subir
                </Button>
                    ...
                    <div key={resource.id} className="flex items-center justify-between py-2 border-b last:border-0">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          onClick={() => onDeleteResource(resource.id, lesson.id)}
                        >
